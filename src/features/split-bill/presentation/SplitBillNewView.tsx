    ...
    <main className="min-h-screen">
      <div className="px-4 pt-4 pb-8 md:px-6 md:pt-6 max-w-lg mx-auto">
        ...
        <header className="flex items-center gap-3 mb-6">
          <button
            onClick={() => (vm.step > 0 ? vm.setStep((vm.step - 1) as any) : router.back())}
          ...
          <div className="flex-1">
            <h1 className="text-xl font-bold tracking-tight">New Split Bill</h1>
            ...
            <Field label="Participants">
              <div className="space-y-2">
                {vm.participants.map((p) => (
                  <div key={p.localId} className="flex gap-2">
                    <input
                ...
                <div key={adj.localId} className="rounded-xl ring-1 ring-border p-3 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <select
                      className={`${inputCls} flex-1`}
                      value={adj.type}
                      onChange={(e) => vm.updateAdjustment(adj.localId, { type: e.target.value as any })}
                    >
        ...
        {vm.step === 4 && (
          <div className="space-y-6">
            ...
            <Button
              ...
              onClick={vm.submit}
            >
              {vm.isSubmitting ? 'Creating...' : 'Create Bill'}
            </Button>
          </div>
        )}
      </div>
