    ...
    <div className="rounded-xl ring-1 ring-border bg-card p-4 space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <input
              type="date"
              className="w-full h-11 rounded-lg bg-muted/50 ring-1 ring-border px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-2">
          ...
          <select
            className="w-full h-11 rounded-lg bg-muted/50 ring-1 ring-border px-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all appearance-none cursor-pointer"
