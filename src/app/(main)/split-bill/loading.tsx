    ...
    <main className="min-h-screen">
      <div className="px-4 pt-4 pb-8 md:px-6 md:pt-6 max-w-lg mx-auto">
        <header className="flex items-center justify-between mb-8">
          <div className="h-8 w-32 rounded-lg bg-muted dark:bg-accent animate-pulse" />
          <div className="h-8 w-24 rounded-xl bg-muted dark:bg-accent animate-pulse" />
        </header>
        ...
        <div className="mb-6 space-y-2">
          ...
          <div className="space-y-2">
            {[1, 2].map((i) => (
              <div key={i} className="h-16 w-full rounded-2xl bg-muted dark:bg-accent animate-pulse" />
            ))}
          </div>
        </div>
